...
--Toman{origen, compañía, vuelo, pasaporte}
...
VUELO NUMBER,
PASAPORTE NUMBER,
CONSTRAINT PK_TOMAN PRIMARY KEY (ORIGEN, COMPAÑIA, VUELO, PASAPORTE)
);

COMMIT;

--Compañía{Código, nombre}
...
--Vuelos2{Compañia, vuelo, origen, destino, horario, nombre, Nº Serie, amtigüedad, hora_vuelo, fecha, caracteristicas, fecha_operan}

CREATE TABLE VUELOS2(
COMPAÑIA VARCHAR2(50) NOT NULL,
VUELO NUMBER NOT NULL,
ORIGEN VARCHAR2(20) NOT NULL,
DESTINO VARCHAR2(20),
