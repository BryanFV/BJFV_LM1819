...
$producto = trim(htmlspecialchars( strip_tags ($_REQUEST["producto"]), ENT_QUOTES, "UTF-8"));
...
$proveedor = trim(htmlspecialchars( strip_tags ($_REQUEST["proveedor"]), ENT_QUOTES, "UTF-8"));
